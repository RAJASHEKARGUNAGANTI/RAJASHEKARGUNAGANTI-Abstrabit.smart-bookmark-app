      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-gray-900 hidden sm:block">Smart Bookmark</h1>
          </div>
          {isLiveWindow && (
        ...
        <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="absolute top-full right-0 mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-xl p-4 z-50">
                  <div className="space-y-3">
                    <div className="pb-3 border-b border-gray-100">
                      <h4 className="text-sm font-semibold text-gray-900 mb-1">Sync Modes</h4>
                      <p className="text-xs text-gray-500">Choose how bookmarks sync across tabs</p>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-2 rounded-lg bg-gray-50">
                        <div className="flex items-center gap-2 font-medium text-gray-500 mb-1">
                  ...
                  <button
                    onClick={() => setShowModeInfo(false)}
                    className="mt-3 w-full text-xs text-gray-500 hover:text-gray-700 py-2 rounded-md hover:bg-gray-50 transition-colors"
                  >
                    Close
                  </button>
                </div>
          ...
          {liveActive ? (
            <button
              type="button"
              onClick={exitLive}
              className="flex items-center gap-2 rounded-lg bg-green-100 px-3 sm:px-4 py-2 text-sm font-medium text-green-800 transition-all hover:bg-green-200 hover:shadow-md"
            >
            ...
            <button
              type="button"
              onClick={toggleLive}
              className="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-3 sm:px-4 py-2 text-sm font-medium text-gray-700 transition-all hover:bg-green-50 hover:text-green-700 hover:border-green-300 hover:shadow-sm"
            >
          ...
          {/* User Email */}
          <span className="text-sm text-gray-600 hidden lg:inline max-w-[150px] truncate" title={userEmail}>
            {userEmail}
          </span>
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-3 sm:px-4 py-2 text-sm font-medium text-gray-700 transition-all hover:bg-red-50 hover:text-red-700 hover:border-red-300 hover:shadow-sm"
          >
