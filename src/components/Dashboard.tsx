...
//   const broadcastUpdate = useCallback((type: "refresh" | "insert" | "update" | "delete", bookmarkId?: string) => {
//     if (channelRef.current && syncMode === "webhook") {
//       channelRef.current.send({
//         type: "broadcast",
//         event: "bookmark-update",
//         payload: { type, bookmarkId, timestamp: Date.now() },
//       });
//     }
//   }, [syncMode]);
...
//     const handleVisibilityChange = () => {
//       if (!document.hidden) {
//         console.log("Tab became visible - fetching bookmarks");
//         fetchBookmarks();
//       }
//     };
...
//     const handleFocus = () => {
//       console.log("Tab gained focus - fetching bookmarks");
//       fetchBookmarks();
//     };
...
//     onConnectionStatusChange("connected");
//     console.log("Time-based polling started (every 3s)");
...
//     return () => {
//       console.log("Time-based polling stopped");
//       clearInterval(interval);
//     };
//   }, [syncMode, fetchBookmarks, onConnectionStatusChange]);
...
//         },
//         (payload) => {
//           console.log("Realtime DB event:", payload.eventType);
...
//           // Optionally refresh on broadcast (for extra safety)
...
//       }
//     };
//   }, [syncMode, userId, fetchBookmarks, onConnectionStatusChange]);
...
//       // For non-webhook modes, fetch immediately
//       if (syncMode !== "webhook") {
//         await fetchBookmarks();
//       }
//     } catch (err) {
